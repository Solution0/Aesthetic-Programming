...
var apikey = "AIzaSyCufeMXf3xtfOi1qVBhdOviXoGaiChb6Qk";  //register API key here: https://developers.google.com/custom-search/json-api/v1/overview
var engineID = "004188004317700778214:jdxgxtgvvy4"; //https://cse.google.com/all  | create search engine, then get the searchengine ID - make sure image is on

var query = "bicycle";  //search keywords
var imgSize ="large"; //xxlarge, check here: https://developers.google.com/custom-search/json-api/v1/reference/cse/list#parameters
